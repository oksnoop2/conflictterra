	...
	local function RestoreAfterDelay(unitID)
		Sleep(2500)
		Turn(turret1, y_axis, 0, math.rad(90))
        	Turn(barrel1, x_axis, 0, math.rad(50))
		Turn(turret2, y_axis, 0, math.rad(90))
        	Turn(barrel2, x_axis, 0, math.rad(50))
		Turn(turret3, y_axis, 0, math.rad(90))
        	Turn(barrel3, x_axis, 0, math.rad(50))
		Turn(turret4, y_axis, 0, math.rad(90))
        	Turn(barrel4, x_axis, 0, math.rad(50))
		Turn(turret5, y_axis, 0, math.rad(90))
        	Turn(barrel5, x_axis, 0, math.rad(50))
		Turn(turret6, y_axis, 0, math.rad(90))
        	Turn(barrel6, x_axis, 0, math.rad(50))
	end
	...
	function script.AimWeapon1( heading, pitch )
		...
		SetSignalMask(SIG_AIM)
        	...
        	Turn(barrel1, x_axis, -pitch, math.rad(50))
	...
	function script.AimWeapon3( heading, pitch )
		...
		SetSignalMask(SIG_AIM_THIR)
        	...
        	Turn(barrel2, x_axis, -pitch, math.rad(50))
	...
	function script.AimWeapon5( heading, pitch )
		...
		SetSignalMask(SIG_AIM_FIVE)
        	Turn(turret3, y_axis, heading, math.rad(90))
        	Turn(barrel3, x_axis, -pitch, math.rad(50))
	...
	function script.AimWeapon7( heading, pitch )
		...
		SetSignalMask(SIG_AIM_SEV)
        	Turn(turret4, y_axis, heading, math.rad(90))
        	Turn(barrel4, x_axis, -pitch, math.rad(50))
	...
	function script.AimWeapon9( heading, pitch )
		...
		SetSignalMask(SIG_AIM_NIN)
        	Turn(turret5, y_axis, heading, math.rad(90))
        	Turn(barrel5, x_axis, -pitch, math.rad(50))
	...
	function script.AimWeapon11( heading, pitch )
		...
		SetSignalMask(SIG_AIM_ELE)
        	Turn(turret6, y_axis, heading, math.rad(90))
        	Turn(barrel6, x_axis, -pitch, math.rad(50))
