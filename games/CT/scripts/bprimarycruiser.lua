	--Oda Class Cruiser animation script by Sanada
	...
	function script.Activate()
		Turn( frontgear, x_axis, 0, 2 )
		Turn( lmidgear, z_axis, 0, 2 )
		Turn( rmidgear, z_axis, 0, 2 )
		Move( frontgear, z_axis, 0, 25 )
		Move( lmidgear, x_axis, 0, 25 )
		Move( rmidgear, x_axis, 0, 25 )
		Move( reargear, y_axis, 0, 25 )
	end
