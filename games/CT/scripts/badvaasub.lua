	...
	local function RestoreAfterDelay(unitID)
		...
		Turn(forgun, y_axis, 0, math.rad(90))
		Turn(forgun, x_axis, 0, math.rad(50))
        	Turn(reargun, y_axis, 0, math.rad(90))
        	Turn(reargun, x_axis, 0, math.rad(50))
	end
	...
	function script.AimWeapon1( heading, pitch )
		...
		Move(hull, y_axis, 30, 45)
        	...
        	Turn(forgun, x_axis, -pitch, math.rad(50))
	...
	function script.AimWeapon3( heading, pitch )
		...
		Move(hull, y_axis, 30, 45)
        	...
        	Turn(reargun, x_axis, -pitch, math.rad(50))
