	...
	local movingbarrel = piece "movingbarrel"
	local flare1 = piece "flare1"

	local bolt = piece "bolt"
	...
	local trackn = 17					--number of tracks per side
	local trackspeed = 0.4				--how fast the track revolves
	local trackheightoffset = 2.8		--move the whole track up or down
	local wheel1x = 0
	local wheel2x = 45
	local wheelr = 2.4					--wheel radius
	local trackoffsetx = 10				--gauge of the tank, how far apart the tracks run
	local D = 20						--distance between center of wheels
