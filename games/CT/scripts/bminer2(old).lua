...
--wheels
local wheel1r = piece "rfrontwheel"
local wheel2r = piece "rbackwheel"

local wheel1l = piece "lfrontwheel"
local wheel2l = piece "lbackwheel"
...
local D = 16	--distance between center of wheels
