...
TANK_EXPLOSION = {
   ...
   soundstart			= "golgotha/old_generic.wav",
   soundhit				= "golgotha/old_generic.wav",
   explosiongenerator	= "custom:ct_explosion_unit_tank",
	      damage                  = {
		default = 50,  		  
		Cruiser = 50,
		Building = 50,
...
MECH_EXPLOSION = {
   ...
   soundstart			= "golgotha/old_generic.wav",
   soundhit				= "golgotha/old_generic.wav",
   explosiongenerator	= "custom:ct_explosion_unit_mech",
	      damage                  = {
		default = 100,  		  
		Cruiser = 100,
		Building = 100,
...
AIRCRAFT_EXPLOSION = {
   ...
   soundstart			= "golgotha/old_generic.wav",
   soundhit				= "golgotha/old_generic.wav",
   explosiongenerator	= "custom:ct_explosion_unit_aircraft",
	      damage                  = {
		default = 50,  		  
		Cruiser = 50,
		Building = 50,
...
CRUISER_EXPLOSION = {
   ...
   soundstart			= "golgotha/old_generic.wav",
   soundhit				= "golgotha/old_generic.wav",
   explosiongenerator	= "custom:ct_explosion_unit_cruiser",
	      damage                  = {
		default = 200,  		  
		Cruiser = 200,
		Building = 200,
